...
const GroupMain = ({ group, isShowed, onFlip, onRemove }: Props) => {
  ...
  return (
    <div className={'group-main'}>
      ...
      <Button href={group.url?.inordic} target="_blank" rel="noopener noreferrer" variant="contained" color="secondary">
        Открыть уроки
      </Button>
